...
const POINTS = [
  { Mark: MarkBolt, label: 'Instant XP', sub: 'They finish, tap, and the points land. You get notified and can ask for a photo afterward.' },
      ...
      <section style={{ padding: '120px 32px' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <Reveal style={{ maxWidth: 660, marginBottom: 52 }}>
            ...
            <p style={{ margin: 0, fontSize: 17.5, lineHeight: 1.6, color: 'var(--txm)' }}>
              No waiting on a parent to log in and bless it. They finish, they tap, and the points land. You get notified and can ask for a photo
              afterward if something looks suspiciously clean.
            </p>
          </Reveal>
        ...
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 56, alignItems: 'center' }}>
          <Reveal>
            ...
            <p style={{ margin: '0 0 16px', fontSize: 17.5, lineHeight: 1.6, color: 'var(--txm)' }}>
              Poppins is the AI built into ChoreMaxx, and it&rsquo;s yours — Admins only. Ask it anything about how the app works, or just tell it
            ...
            <p style={{ margin: 0, fontSize: 18, fontWeight: 650, letterSpacing: '-.02em', color: 'var(--tx)' }}>
              It answers, and it acts. Sidekicks don&rsquo;t get access to it. Sidekicks get their tasks.
            </p>
          </Reveal>
          <Reveal>
            <div style={{ ...glass, padding: 30, borderRadius: 30 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 11, marginBottom: 18 }}>
                ...
                <span style={{ marginLeft: 'auto', fontSize: 12, color: 'var(--txm)' }}>Admins only</span>
              </div>
      ...
      <section id="pricing" style={{ padding: '120px 32px', background: 'var(--bgs)', borderTop: '1px solid var(--bd)', borderBottom: '1px solid var(--bd)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 20 }}>
            {[
              { title: 'Monthly', price: '$4.99', period: '/month', note: '7 days free, then billed monthly through Apple.', highlight: false },
              { title: 'Yearly', price: '$48', period: '/year', note: '7 days free, then billed yearly through Apple. Everything above, two months cheaper.', highlight: true },
            ].map((tier) => (
